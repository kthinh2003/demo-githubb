...
<form class="row g-3" method="POST" action="{{ route('sinh-vien.xl-them-moi') }}">
    <div class="col-12">
        @csrf
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="text" name="ho_ten" class="form-control" id="ho-ten">
            </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <select name="lop" class="form-select" aria-label="Default select example" id="lop">
